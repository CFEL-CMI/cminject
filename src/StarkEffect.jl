...
- `B`: The second rotational constant, B=h/(8π^2⋅I_b)
- `D`: The centrifugal distortion constant
- `μ`: The dipole moment along its symmetry axis
"""
...
Calculates the energies for the given J quantum number range, M quantum number and field strength.
...
Calculates the hamiltonian for the given range of J quantum numbers, the M quantum number and the field strength.
