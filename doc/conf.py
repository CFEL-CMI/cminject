...
# os.path.abspath to make it absolute, like shown here. sys.path.insert(0, os.path.abspath('.'))
...
latex_documents = [
  ('index', 'CMIstark.tex', 'CMIstark Documentation', 'CFEL Controlled Molecule Imaging', 'manual'),
]
...
man_pages = [
    ('index', 'cmistark', 'CMIstark Documentation',
     ['CFEL Controlled Molecule Imaging'], 1)
]
...
texinfo_documents = [
  ('index', 'CMIstark', 'CMIstark Documentation',
   'Controlled Molecule Imaging group', 'CMIstark', 'One line description of project.',
   'Miscellaneous'),
]
